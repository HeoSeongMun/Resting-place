...
class Order_DeliveryListItem extends StatefulWidget {
  final DocumentSnapshot<Map<String, dynamic>> documentSnapshot;

  const Order_DeliveryListItem({Key? key, required this.documentSnapshot})
      : super(key: key);

  @override
  _Order_DeliveryListItem createState() => _Order_DeliveryListItem();
}

class _Order_DeliveryListItem extends State<Order_DeliveryListItem> {
